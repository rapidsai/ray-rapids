...
class Comms:
    ...
    valid_nccl_placements = ("client", "worker", "scheduler", "ray-actor")
    ...
    def create_nccl_uniqueid(self):
        ...
        elif self.nccl_root_location == 'ray-actor':
            # ray-actor is similar to client.  nccl will run in the local
            # actor process
            self.uniqueId = nccl.get_unique_id()
        else:
    ...
    def init(self, workers=None):
        ...
        # init_all needs to be done at the for ray actor level
